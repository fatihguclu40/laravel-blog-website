        ...
        <div class="container">
            <div class="logo">
                <a href="index.html">
                    <img alt="Porto" width="111" height="54" data-sticky-width="82" data-sticky-height="40"
                         src="/uploads/img/{{$ayarlar[0]->logo}}">
                </a>
            </div>
            ...
            <nav>
                <ul class="nav nav-pills nav-top">
                    @if(Auth::user())
                        @php($user = Auth::user())
                        <li><a style="color: #0e90d2">Hoşgeldiniz</a></li>
                        <li><a style="color: red">{{$user->name}}</a></li>
                        <li>
                            <a style="color: #0e90d2" href="/cikis-yap">Çıkış Yap</a>
                        </li>
                    @else
                        <li>
                            <a style="color: #0e90d2" href="/giris-yap">Giriş Yap</a>
                        </li>
                        <li class="phone">
                            <a style="color: #0e90d2" href="/kayit">Üye Ol</a>
                        </li>
                    @endif
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    <div class="social-icons">
                        <ul class="social-icons">
                            <li class="facebook"><a href="http://www.facebook.com/" target="_blank"
                                                    data-placement="bottom" data-tooltip title="Facebook">Facebook</a>
                            </li>
                            <li class="twitter"><a href="http://www.twitter.com/" target="_blank"
                                                   data-placement="bottom" data-tooltip title="Twitter">Twitter</a></li>
                            <li class="linkedin"><a href="http://www.linkedin.com/" target="_blank"
                                                    data-placement="bottom" data-tooltip title="Linkedin">Linkedin</a>
                            </li>
                        </ul>
                    </div>
                </div>
