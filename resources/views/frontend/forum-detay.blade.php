                        ...
                        <div class="post-content">
                                            ...
                                            <div class="comment-block">
                                                ...
                                                <span class="comment-by">
																...
																<span class="pull-right">
																	<span> <a style="cursor: pointer;" onclick="altyorum({{$yorum->id}})"><i class="fa fa-reply"></i> Cevapla</a></span>
																</span>
															</span>
                                                <p>{{$yorum->icerik}}</p>
                            ...
                            <div class="post-block post-leave-comment">
                                ...
                                <form action="" method="post" id="form">
                                    ...
                                    @endif
                                    @if(\Illuminate\Support\Facades\Auth::check())
                                        <input type="hidden" value="" maxlength="100" class="form-control" name="isim" id="isim">
                                        <input type="hidden" value="" maxlength="100" class="form-control" name="mail" id="isim">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            @else
                                                <a href="/giris-yap"><button type="button"  class="btn btn-primary btn-lg">Gönder</button></a>
                                            @endif
